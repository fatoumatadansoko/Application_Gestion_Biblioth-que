    ...
    <div class="container">
        ...
        <form action="{{ route('ajouter_livre_traitement') }}" method="POST" class="form-group">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="nombre_page" name="nombre_page" value="{{ old('nombre_page') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="editeur" name="editeur" value="{{ old('editeur') }}">
            </div>
            <div class="mb-3">
